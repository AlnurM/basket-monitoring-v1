...
- [x] 02-03-PLAN.md — Product handlers (URL input, validation, first-scrape, item display, removal) + price history cleanup job
...
- [x] 04-03-PLAN.md — Bot handlers (/changes, /compare, /chart, /chart_item, /export), router wiring, alert hook, i18n keys, TXUX-03 audit
